...
namespace Microsoft.Teams.Apps.RewardAndRecognition.Providers
{
    ...
    public class StorageBaseProvider
    {
        ...
        public StorageBaseProvider(StorageOptions storageOptions, string tableName)
        {
            storageOptions = storageOptions ?? throw new ArgumentNullException(nameof(storageOptions));
            this.connectionString = storageOptions.ConnectionString;
            this.tableName = tableName;
            this.initializeTask = new Lazy<Task>(() => this.InitializeAsync());
        }

        /// <summary>
        /// Gets or sets cloud table for storing details regarding sending notification.
        /// </summary>
